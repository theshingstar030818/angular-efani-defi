...
let AppService = class AppService {
    ...
    subscribe(phoneNumber, speed, gasPrice) {
        const Subscriber = parse__WEBPACK_IMPORTED_MODULE_3__["Object"].extend('Subscribers');
    ...
    getSubscribers() {
        const Subscribers = parse__WEBPACK_IMPORTED_MODULE_3__["Object"].extend('Subscribers');
        const query = new parse__WEBPACK_IMPORTED_MODULE_3__["Query"](Subscribers);
        return query.find();
    }
    getGas() {
        const options = {
...
module.exports = __webpack_require__(/*! /Users/tanzeel.rehman/Development/cardano/DeFi/defi-pools/src/main.ts */"./src/main.ts");
