...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "\n<mat-grid-list cols=\"4\" rowHeight=\"1:1\">\n    <mat-grid-tile>\n        <mat-card>\n            <mat-icon>slow_motion_video</mat-icon> Safe Low\n            <h4>{{gas.safeLow/10}} gwei</h4>\n            <h5>{{getWaitTimeString(gas.safeLowWait)}}</h5>\n        </mat-card>\n    </mat-grid-tile>\n    <mat-grid-tile>\n        <mat-card>\n            <mat-icon>more_time</mat-icon> Average\n            <h4>{{gas.average/10}} gwei</h4>\n            <h5>{{getWaitTimeString(gas.avgWait)}}</h5>\n        </mat-card>\n    </mat-grid-tile>\n    <mat-grid-tile>\n        <mat-card>\n            <mat-icon>speed</mat-icon> Fast\n            <h4>{{gas.fast/10}} gwei</h4>\n            <h5>{{getWaitTimeString(gas.fastWait)}}</h5>\n        </mat-card>\n    </mat-grid-tile>\n    <mat-grid-tile>\n        <mat-card>\n            <mat-icon>speed</mat-icon> Fastest\n            <h4>{{gas.fastest/10}} gwei</h4>\n            <h5>{{getWaitTimeString(gas.fastestWait)}}</h5>\n        </mat-card>\n    </mat-grid-tile>\n    <mat-grid-list cols=\"1\" >\n        <mat-grid-tile>\n            <mat-card>\n                <form class=\"form\" [formGroup]=\"subscriberForm\" (ngSubmit)=\"saveSubscriber()\">\n                    <mat-form-field class=\"full-width\">\n                        <mat-label>Enter Gas Price (gwei)</mat-label>\n                        <input matInput type=\"number\" formControlName=\"gasPrice\">\n                    </mat-form-field>\n                    <mat-form-field appearance=\"fill\">\n                        <mat-label>Select Speed</mat-label>\n                        <select matInput matNativeControl formControlName=\"speed\">\n                            <option value=\"safeLow\">Safe Low</option>\n                            <option value=\"average\" selected>Average</option>\n                            <option value=\"fast\">Fast</option>\n                            <option value=\"fastest\">Fastest</option>\n                        </select>\n                    </mat-form-field>\n                    <mat-form-field class=\"full-width\">\n                        <mat-label>Enter Phone Number (Get notified when gas is at/below {{subscriberForm.value.gasPrice}} gwei)</mat-label>\n                        <input matInput type=\"tel\" formControlName=\"phoneNumber\">\n                    </mat-form-field>\n                    <button mat-raised-button type=\"submit\" [disabled]=\"!subscriberForm.valid\">Subscribe</button>\n                </form>\n            </mat-card>\n        </mat-grid-tile>\n    </mat-grid-list>\n</mat-grid-list>\n\n";
    /***/
  },
  ...
  function srcAppAppComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".form {\n    min-width: 150px;\n    max-width: 500px;\n    width: 100%;\n}\n\n.full-width {\n    width: 100%;\n}\n\n.mat-card {\n    width: 75%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(appService) {
        ...
        this.gas = {};
        this.defaultSpeed = 'safeLow';
        this.subscriberForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
          phoneNumber: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](null, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]),
          speed: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](this.defaultSpeed, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]),
          gasPrice: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](70, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required])
        });
        ...
        appService.getGas().subscribe(function (data) {
          console.log(data);
          _this.gas = data;
        });
        appService.getSubscribers().then(function (subscribers) {
      ...
      _createClass(AppComponent, [{
        key: "saveSubscriber",
        value: function saveSubscriber() {
          console.log(this.subscriberForm.value);
          var formValue = this.subscriberForm.value;
          this.appService.subscribe(formValue.phoneNumber, formValue.speed, formValue.gasPrice).then(function (savedSubscriber) {
        ...
        key: "getWaitTimeString",
        value: function getWaitTimeString(minutes) {
  ...
  function srcAppAppServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    parse__WEBPACK_IMPORTED_MODULE_3__["initialize"]('YOUR_APP_ID'); // use your appID & your js key

    parse__WEBPACK_IMPORTED_MODULE_3__["serverURL"] = 'ht' + 'tp://localhost:1337/parse'; // use your server url
    ...
    var AppService = /*#__PURE__*/function () {
      function AppService(client) {
        ...
        this.client = client;
        this.apiKey = "03dc0f3c785e965b6c5cdff5d627fe508f15bfeb960b3c0842ced89fefec";
        this.exchangesUrl = 'https://data-api.defipulse.com/api/v1/blocklytics/pools/v1/exchanges';
        this.ethGasUrl = 'https://data-api.defipulse.com/api/v1/egs/api/ethgasAPI.json';
        console.log(this.apiKey);
      }

      _createClass(AppService, [{
        key: "subscribe",
        value: function subscribe(phoneNumber, speed, gasPrice) {
          var Subscriber = parse__WEBPACK_IMPORTED_MODULE_3__["Object"].extend('Subscribers');
        ...
        value: function getSubscribers() {
          var Subscribers = parse__WEBPACK_IMPORTED_MODULE_3__["Object"].extend('Subscribers');
          var query = new parse__WEBPACK_IMPORTED_MODULE_3__["Query"](Subscribers);
          return query.find();
        }
      }, {
        key: "getGas",
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/tanzeel.rehman/Development/cardano/DeFi/defi-pools/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
